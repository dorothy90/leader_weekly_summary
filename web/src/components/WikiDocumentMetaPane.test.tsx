...
const page: CategoryWikiPage = {
  ...
  body_markdown: '# 4SA',
  citation_map: [
    { mail_id: 'mail-1', agenda_ids: ['agenda-1'], used_in_sections: ['개요'], category_paths: ['dram/spica/4sa'] },
    { mail_id: 'mail-2', agenda_ids: ['agenda-2'], used_in_sections: ['개요'], category_paths: ['dram/spica/4sa'] },
  ],
